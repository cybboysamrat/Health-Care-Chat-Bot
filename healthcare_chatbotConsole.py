...
training_dataset = pd.read_csv('F:\Health Care Chat-Bot\Training.csv')
test_dataset = pd.read_csv('F:\Health Care Chat-Bot\Testing.csv')
...
doc_dataset = pd.read_csv('F:\Health Care Chat-Bot\doctors_dataset.csv', names = ['Name', 'Description'])
